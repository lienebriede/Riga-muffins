...
- The Website was tested using [Google Chrome Lighthouse Tool](https://github.com/lienebriede/Riga-muffins/index.html). The Accessability score on pages "Home" and "Franchising" is 100, and 98 on the page "Our products".
